...
<div class="section innerpager" id="news-page">
	<ul class="nav nav-tabs text-center news--tab">
		<?php $terms = get_terms('loai_tin_tuc'); var_dump('loai_tin_tuc') ?>
		<li role="presentation" class="">
			<a href="http://goldenriver.vinhomes.vn/tin-tuc/tin-tuc-cong-ty/">Tin công ty</a>
		</li>
		<li role="presentation" class="active">
			<a href="http://goldenriver.vinhomes.vn/tin-tuc/tin-bao-chi/">Tin báo chí</a>
		</li>    
	</ul>
